...
import net.chrisgrollier.cloud.apps.sample.user.exception.FunctionalException;
import net.chrisgrollier.cloud.apps.sample.user.exception.UnrecoverableFunctionalException;
